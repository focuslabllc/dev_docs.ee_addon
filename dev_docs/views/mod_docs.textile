...
|^.
|_. Field|_. Short Name|_. Description|_. Options|_. Required|
|-.
...
|^.
|_. Name|_. Type|_. Usage Description|_. License|
|-.
...
|"SEO Lite":http://www.addonbakery.com/expressionengine-addons/seolite.html|Module|Used to help offer per content entry metadata as well as site-wide defaults to help with basic search engine optimization.|Free|
